...
public abstract class AbstractCompiler implements SourceExcerptProvider {
   ...
   */
  public abstract CompilerInput newExternInput(String name);
   ...
   */
  public abstract List<CompilerInput> getInputsInOrder();
   ...
   */
  public abstract void throwInternalError(String msg, Exception cause);
   ...
   */
  public abstract void addToDebugLog(String message);

  /**
   * Sets the CssRenamingMap.
   */
  public abstract void setCssRenamingMap(CssRenamingMap map);
   ...
   */
  public abstract Node parseTestCode(String code);
   ...
   */
  public abstract void addChangeHandler(CodeChangeHandler handler);

  /**
   * Remove a listener for code change events.
   */
  public abstract void removeChangeHandler(CodeChangeHandler handler);

  /**
   * Returns true if compiling in IDE mode.
   */
  public abstract boolean isIdeMode();

  /**
   * @return Whether the compiler is in ES5Mode.
   */
  public abstract boolean acceptEcmaScript5();

  /**
   * @return Whether the compiler accepts `const' keyword.
   */
  public abstract boolean acceptConstKeyword();
   ...
   */
  public abstract boolean isTypeCheckingEnabled();
   ...
   */
  public abstract void prepareAst(Node root);
   ...
   */
  public abstract boolean areNodesEqualForInlining(Node n1, Node n2);
   ...
   *     properties.
   */
  public abstract void setHasRegExpGlobalReferences(boolean references);
   ...
   */
  public abstract CheckLevel getErrorLevel(JSError error);
