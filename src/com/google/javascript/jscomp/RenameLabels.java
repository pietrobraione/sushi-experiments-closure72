...
public final class RenameLabels implements CompilerPass {
   ...
   */
  /*SUSHI: Workaround*/public static String[] fake_names;
  /*SUSHI: Workaround*/public static int fake_names_index;
  class ProcessLabels implements ScopedCallback {
    ...
    ProcessLabels() {
      ...
      //SUSHI  Workaround: BEGIN
      fake_names_index = 0;
      fake_names = new String[10];
      fake_names[0] = "0";
      fake_names[1] = "1";
      fake_names[2] = "2";
      fake_names[3] = "3";      
      //SUSHI  Workaround: END
    }
    ...
    public boolean shouldTraverse(NodeTraversal nodeTraversal, Node node,
      ...
      if (node.getType() == Token.LABEL) {
        ...
        /*SUSHI: JBSE does not handle equality checks for symbolic strings. Workaround: Remove this precondition check*///Preconditions.checkState(!current.renameMap.containsKey(name));
